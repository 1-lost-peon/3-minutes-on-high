extends Node2D
class_name Barricate

## Barricate in the world which is damageable.
## Enemies, Player and Projectiles can not pass through this obstacle.

## Maximum hp of the barricate.
@export var max_hp : float = 25.0

## Current hp of the barricate, defaults to the max_hp on ready.
...
# Show visual indicating barricate took damage.
func _show_take_damage_visual() -> void:
	pass

# Show the breaking barricate visual and then queue free this barricate.
